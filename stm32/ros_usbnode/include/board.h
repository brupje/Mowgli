...
#define MAX_MPS 0.35		  // Allow maximum speed of 1.0 m/s
...
#define WHEEL_BASE  0.32		// The distance between the center of the wheels in meters
...
#define BAT_CHARGE_CUTOFF_VOLTAGE 29.0f
